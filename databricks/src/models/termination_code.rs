...
impl ToString for TerminationCode {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::AZURERESOURCEPROVIDERTHROTTLING => String::from("AZURE_RESOURCE_PROVIDER_THROTTLING"),
            Self::AZURERESOURCEMANAGERTHROTTLING => String::from("AZURE_RESOURCE_MANAGER_THROTTLING"),
            Self::NETWORKCONFIGURATIONFAILURE => String::from("NETWORK_CONFIGURATION_FAILURE"),
